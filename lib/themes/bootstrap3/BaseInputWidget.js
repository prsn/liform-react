...
var BaseInputWidget = function (_React$Document) {
  _inherits(BaseInputWidget, _React$Document);
  ...
  _createClass(BaseInputWidget, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        "div",
        { onMouseEnter: this.toggleHovering, onMouseLeave: this.toggleHovering },
        editMode && isHovering && _react2.default.createElement(
          "div",
          null,
          "Edit Icons..."
        ),
