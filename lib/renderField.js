...
var renderField = function renderField(fieldSchema, fieldName, theme) {
  ...
  var isEditMode = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : false;
  var onEdit = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : function () {};
  var onDelete = arguments.length > 7 && arguments[7] !== undefined ? arguments[7] : function () {};
