...
var renderFields = function renderFields(schema, theme) {
  ...
  var onEdit = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : function () {};
  var onDelete = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : function () {};
  ...
  return _lodash2.default.map(props, function (item) {
    ...
    return (0, _renderField2.default)(field, name, theme, prefix, context, isEditMode, onEdit, onDelete, isRequired(schema, name));
  });
};
